...
async function h\u00e4mtaData() {
    try {
        ...
        if (!response.ok) throw new Error("N\xe5got gick fel vid h\xe4mtning av data");
...
function s\u00f6kData(data, s\u00f6ktext) {
    return data.filter((kurs)=>kurs.code.toLowerCase().includes(s\u00f6ktext) || kurs.coursename.toLowerCase().includes(s\u00f6ktext));
}
